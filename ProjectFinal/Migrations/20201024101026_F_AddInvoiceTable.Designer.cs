...
namespace ProjectFinal.Migrations
{
    ...
    [Migration("20201024101026_F_AddInvoiceTable")]
    partial class F_AddInvoiceTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectFinal.Models.Invoice.Invoice", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("InvoiceProductPrice")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("UserInvoicesid")
                        .HasColumnType("int");

                    b.HasKey("id");

                    b.HasIndex("UserInvoicesid");

                    b.ToTable("Invoice");
                });

            modelBuilder.Entity("ProjectFinal.Models.Invoice.UserInvoices", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjectFinal.Models.Invoice.Invoice", b =>
                {
                    b.HasOne("ProjectFinal.Models.Invoice.UserInvoices", null)
                        .WithMany("Invoices")
                        .HasForeignKey("UserInvoicesid");
                });

            modelBuilder.Entity("ProjectFinal.Models.Invoice.UserInvoices", b =>
                {
                    b.HasOne("ProjectFinal.Models.DbPassportUserModel", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
